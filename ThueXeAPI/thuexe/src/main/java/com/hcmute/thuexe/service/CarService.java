...
public class CarService {
    ...
    @Transactional
    public void editCar(Long carId, EditCarRequest request, Authentication authentication) {
        ...
        car.setEnergyConsumption(request.getEnergyConsumption());
        car.setLocation(request.getLocation());
        car.setPrice(request.getPrice());
        car.setImageUrl(request.getImageUrl());
        car.setDriverRequired(request.isDriverRequired());

        // Cập nhật tính năng (hasEtc)
        car.getHasEtc().clear();
        if (request.getHasEtc() != null) {
            car.getHasEtc().addAll(request.getHasEtc());
        }
